module mult_seq_32x32 (clk,
 ...
 sky130_fd_sc_hd__o31a_2 _447_ (.A1(net65),
    ...
    .B1(_074_),
    .X(_075_));
 sky130_fd_sc_hd__clkbuf_4 _448_ (.A(_075_),
    .X(_000_));
 sky130_fd_sc_hd__nor2_2 _449_ (.A(\estado_act[1] ),
    .B(\estado_act[0] ),
    .Y(_076_));
 sky130_fd_sc_hd__or2_1 _450_ (.A(net66),
    .B(_076_),
    .X(_077_));
 ...
 sky130_fd_sc_hd__and4_1 _452_ (.A(\contador_act[3] ),
    ...
    .D(\contador_act[0] ),
    .X(_079_));
 sky130_fd_sc_hd__a21oi_1 _453_ (.A1(\contador_act[4] ),
    .A2(_079_),
    .B1(\contador_act[5] ),
    .Y(_080_));
 ...
 sky130_fd_sc_hd__nor2_2 _457_ (.A(net66),
    .B(_076_),
    .Y(_083_));
 sky130_fd_sc_hd__buf_2 _458_ (.A(_083_),
    .X(_084_));
 sky130_fd_sc_hd__o21a_1 _459_ (.A1(net1),
    .A2(_082_),
    .B1(_084_),
    .X(_085_));
 sky130_fd_sc_hd__nand2_2 _460_ (.A(net65),
    .B(_076_),
    .Y(_086_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _463_ (.A(_088_),
    .X(_089_));
 sky130_fd_sc_hd__clkbuf_4 _464_ (.A(_089_),
    .X(_090_));
 ...
 sky130_fd_sc_hd__nand2_1 _467_ (.A(_084_),
    .B(_092_),
    .Y(_093_));
 sky130_fd_sc_hd__o211a_1 _468_ (.A1(net92),
    .A2(_085_),
    .B1(_087_),
    .C1(_093_),
    .X(_002_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _470_ (.A(_081_),
    .X(_095_));
 sky130_fd_sc_hd__xor2_1 _471_ (.A(net93),
    .B(net12),
    .X(_096_));
 ...
 sky130_fd_sc_hd__and2_1 _478_ (.A(net93),
    .B(net12),
    .X(_102_));
 sky130_fd_sc_hd__a31oi_1 _479_ (.A1(net92),
    .A2(net1),
    .A3(_096_),
    .B1(_102_),
    .Y(_103_));
 ...
 sky130_fd_sc_hd__a221o_1 _486_ (.A1(net95),
    ...
    .C1(_099_),
    .X(_110_));
 sky130_fd_sc_hd__o211a_1 _487_ (.A1(net94),
    .A2(_094_),
    .B1(_101_),
    .C1(_110_),
    .X(_004_));
 ...
 sky130_fd_sc_hd__o2bb2a_1 _504_ (.A1_N(net97),
    ...
    .B2(_125_),
    .X(_126_));
 sky130_fd_sc_hd__o21ai_1 _505_ (.A1(net96),
    .A2(_084_),
    .B1(_086_),
    .Y(_127_));
 ...
 sky130_fd_sc_hd__a221o_1 _541_ (.A1(net102),
    ...
    .C1(_158_),
    .X(_159_));
 sky130_fd_sc_hd__o211a_1 _542_ (.A1(net101),
    .A2(_094_),
    .B1(_101_),
    .C1(_159_),
    .X(_010_));
 ...
 sky130_fd_sc_hd__a211o_1 _563_ (.A1(net105),
    ...
    .C1(_177_),
    .X(_178_));
 sky130_fd_sc_hd__o211a_1 _564_ (.A1(net104),
    .A2(_094_),
    .B1(_101_),
    .C1(_178_),
    .X(_013_));
 ...
 sky130_fd_sc_hd__a221o_1 _597_ (.A1(net108),
    ...
    .C1(_158_),
    .X(_209_));
 sky130_fd_sc_hd__o211a_1 _598_ (.A1(net107),
    .A2(_094_),
    .B1(_101_),
    .C1(_209_),
    .X(_016_));
 ...
 sky130_fd_sc_hd__o221a_1 _612_ (.A1(_189_),
    ...
    .C1(_221_),
    .X(_222_));
 sky130_fd_sc_hd__o31a_1 _613_ (.A1(_154_),
    .A2(_185_),
    .A3(_218_),
    .B1(_222_),
    .X(_223_));
 ...
 sky130_fd_sc_hd__a221o_1 _620_ (.A1(net110),
    ...
    .C1(_158_),
    .X(_230_));
 sky130_fd_sc_hd__o211a_1 _621_ (.A1(net109),
    .A2(_210_),
    .B1(_216_),
    .C1(_230_),
    .X(_018_));
 ...
 sky130_fd_sc_hd__a221o_1 _637_ (.A1(net113),
    ...
    .C1(_158_),
    .X(_245_));
 sky130_fd_sc_hd__o211a_1 _638_ (.A1(net112),
    .A2(_210_),
    .B1(_216_),
    .C1(_245_),
    .X(_020_));
 ...
 sky130_fd_sc_hd__a211o_1 _645_ (.A1(net114),
    ...
    .C1(_251_),
    .X(_252_));
 sky130_fd_sc_hd__o211a_1 _646_ (.A1(net113),
    .A2(_210_),
    .B1(_216_),
    .C1(_252_),
    .X(_021_));
 ...
 sky130_fd_sc_hd__a221o_1 _677_ (.A1(net117),
    ...
    .C1(_158_),
    .X(_281_));
 sky130_fd_sc_hd__o211a_1 _678_ (.A1(net116),
    .A2(_210_),
    .B1(_216_),
    .C1(_281_),
    .X(_024_));
 sky130_fd_sc_hd__xor2_1 _679_ (.A(net117),
    .B(net16),
    .X(_282_));
 ...
 sky130_fd_sc_hd__a211o_1 _683_ (.A1(net118),
    ...
    .C1(_285_),
    .X(_286_));
 sky130_fd_sc_hd__o211a_1 _684_ (.A1(net117),
    .A2(_210_),
    .B1(_216_),
    .C1(_286_),
    .X(_025_));
 ...
 sky130_fd_sc_hd__a21oi_1 _689_ (.A1(_262_),
    ...
    .B1(_290_),
    .Y(_291_));
 sky130_fd_sc_hd__nand2_1 _690_ (.A(net118),
    .B(net17),
    .Y(_292_));
 ...
 sky130_fd_sc_hd__nand2_1 _692_ (.A(_292_),
    .B(_293_),
    .Y(_294_));
 sky130_fd_sc_hd__or2_1 _693_ (.A(_291_),
    .B(_294_),
    .X(_295_));
 ...
 sky130_fd_sc_hd__a221o_1 _695_ (.A1(net119),
    ...
    .C1(_158_),
    .X(_297_));
 sky130_fd_sc_hd__o211a_1 _696_ (.A1(net118),
    .A2(_210_),
    .B1(_216_),
    .C1(_297_),
    .X(_026_));
 sky130_fd_sc_hd__nand2_1 _697_ (.A(net119),
    .B(net18),
    .Y(_298_));
 ...
 sky130_fd_sc_hd__a22o_1 _774_ (.A1(net44),
    ...
    .B2(net89),
    .X(_366_));
 sky130_fd_sc_hd__mux2_1 _775_ (.A0(net78),
    .A1(_366_),
    .S(_000_),
    .X(_367_));
 ...
 sky130_fd_sc_hd__a22o_1 _777_ (.A1(net55),
    ...
    .B2(net100),
    .X(_368_));
 sky130_fd_sc_hd__mux2_1 _778_ (.A0(net89),
    .A1(_368_),
    .S(_000_),
    .X(_369_));
 ...
 sky130_fd_sc_hd__a22o_1 _786_ (.A1(net60),
    ...
    .B2(net127),
    .X(_374_));
 sky130_fd_sc_hd__mux2_1 _787_ (.A0(net122),
    .A1(_374_),
    .S(_000_),
    .X(_375_));
 sky130_fd_sc_hd__clkbuf_1 _788_ (.A(_375_),
    .X(_040_));
 sky130_fd_sc_hd__buf_2 _789_ (.A(_360_),
    .X(_376_));
 ...
 sky130_fd_sc_hd__a22o_1 _796_ (.A1(net63),
    ...
    .B2(net130),
    .X(_381_));
 sky130_fd_sc_hd__mux2_1 _797_ (.A0(net129),
    .A1(_381_),
    .S(_000_),
    .X(_382_));
 ...
 sky130_fd_sc_hd__a22o_1 _799_ (.A1(net64),
    ...
    .B2(net68),
    .X(_383_));
 sky130_fd_sc_hd__clkbuf_4 _800_ (.A(_075_),
    .X(_384_));
 ...
 sky130_fd_sc_hd__a22o_1 _804_ (.A1(net34),
    ...
    .B2(net69),
    .X(_387_));
 sky130_fd_sc_hd__mux2_1 _805_ (.A0(net68),
    .A1(_387_),
    .S(_384_),
    .X(_388_));
 ...
 sky130_fd_sc_hd__a22o_1 _807_ (.A1(net35),
    ...
    .B2(net70),
    .X(_389_));
 sky130_fd_sc_hd__mux2_1 _808_ (.A0(net69),
    .A1(_389_),
    .S(_384_),
    .X(_390_));
 ...
 sky130_fd_sc_hd__a22o_1 _816_ (.A1(net38),
    ...
    .B2(net73),
    .X(_395_));
 sky130_fd_sc_hd__mux2_1 _817_ (.A0(net72),
    .A1(_395_),
    .S(_384_),
    .X(_396_));
 ...
 sky130_fd_sc_hd__a22o_1 _819_ (.A1(net39),
    ...
    .B2(net74),
    .X(_397_));
 sky130_fd_sc_hd__mux2_1 _820_ (.A0(net73),
    .A1(_397_),
    .S(_384_),
    .X(_398_));
 sky130_fd_sc_hd__clkbuf_1 _821_ (.A(_398_),
    .X(_050_));
 sky130_fd_sc_hd__buf_2 _822_ (.A(_360_),
    .X(_399_));
 ...
 sky130_fd_sc_hd__a22o_1 _826_ (.A1(net41),
    ...
    .B2(net76),
    .X(_402_));
 sky130_fd_sc_hd__mux2_1 _827_ (.A0(net75),
    .A1(_402_),
    .S(_384_),
    .X(_403_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _833_ (.A(_075_),
    .X(_407_));
 sky130_fd_sc_hd__mux2_1 _834_ (.A0(net77),
    .A1(_406_),
    .S(_407_),
    .X(_408_));
 sky130_fd_sc_hd__clkbuf_1 _835_ (.A(_408_),
    .X(_054_));
 sky130_fd_sc_hd__buf_2 _836_ (.A(_362_),
    .X(_409_));
 ...
 sky130_fd_sc_hd__a22o_1 _852_ (.A1(net50),
    ...
    .B2(net85),
    .X(_420_));
 sky130_fd_sc_hd__mux2_1 _853_ (.A0(net84),
    .A1(_420_),
    .S(_407_),
    .X(_421_));
 ...
 sky130_fd_sc_hd__a22o_1 _861_ (.A1(net53),
    ...
    .B2(net88),
    .X(_426_));
 sky130_fd_sc_hd__mux2_1 _862_ (.A0(net87),
    .A1(_426_),
    .S(_407_),
    .X(_427_));
 ...
 sky130_fd_sc_hd__nor2_1 _875_ (.A(_361_),
    .B(_435_),
    .Y(_436_));
 sky130_fd_sc_hd__o21a_1 _876_ (.A1(\contador_act[0] ),
    .A2(_434_),
    .B1(_436_),
    .X(_067_));
 ...
 sky130_fd_sc_hd__nor2_1 _878_ (.A(_361_),
    .B(_437_),
    .Y(_438_));
 sky130_fd_sc_hd__o21a_1 _879_ (.A1(\contador_act[1] ),
    .A2(_435_),
    .B1(_438_),
    .X(_068_));
 ...
 sky130_fd_sc_hd__nor2_1 _881_ (.A(_361_),
    .B(_439_),
    .Y(_440_));
 sky130_fd_sc_hd__o21a_1 _882_ (.A1(\contador_act[2] ),
    .A2(_437_),
    .B1(_440_),
    .X(_069_));
 sky130_fd_sc_hd__o21ai_1 _883_ (.A1(\contador_act[3] ),
    .A2(_439_),
    .B1(_086_),
    .Y(_441_));
 sky130_fd_sc_hd__a21oi_1 _884_ (.A1(\contador_act[3] ),
    .A2(_439_),
    .B1(_441_),
    .Y(_070_));
 ...
 sky130_fd_sc_hd__nor2_1 _886_ (.A(_361_),
    .B(_442_),
    .Y(_071_));
 sky130_fd_sc_hd__and2_1 _887_ (.A(\contador_act[5] ),
    .B(_086_),
    .X(_443_));
 ...
 sky130_fd_sc_hd__dfxtp_1 _958_ (.CLK(clk),
    .D(_069_),
    .Q(\contador_act[2] ));
 sky130_fd_sc_hd__dfxtp_1 _959_ (.CLK(clk),
    .D(_070_),
    .Q(\contador_act[3] ));
 ...
 sky130_fd_sc_hd__buf_1 input15 (.A(mcand[22]),
    .X(net15));
 sky130_fd_sc_hd__dlymetal6s2s_1 input16 (.A(mcand[23]),
    .X(net16));
 ...
 sky130_fd_sc_hd__buf_1 input27 (.A(mcand[4]),
    .X(net27));
 sky130_fd_sc_hd__clkbuf_1 input28 (.A(mcand[5]),
    .X(net28));
 ...
 sky130_fd_sc_hd__buf_1 input37 (.A(mplier[13]),
    .X(net37));
 sky130_fd_sc_hd__buf_1 input38 (.A(mplier[14]),
    .X(net38));
 ...
 sky130_fd_sc_hd__clkbuf_1 input59 (.A(mplier[4]),
    .X(net59));
 sky130_fd_sc_hd__clkbuf_1 input60 (.A(mplier[5]),
    .X(net60));
 ...
 sky130_fd_sc_hd__clkbuf_1 input64 (.A(mplier[9]),
    .X(net64));
 sky130_fd_sc_hd__buf_1 input65 (.A(st),
    .X(net65));
